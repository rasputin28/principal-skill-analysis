...
**Estado (2026-09-24):** Pre-corrida. Runner real implementado. Pre-registro en borrador
(4 campos pendientes de decisión humana). Sin corridas reales ejecutadas aún.
Suite de tests: 96 passed (verificado 2026-09-24). Requiere `pip install -e .` en el venv
antes de la primera ejecución de tests en entorno limpio.

**Bloqueo persistente (14ª noche sin desbloqueo):** Las 3 tareas de ejecución (piloto de banda,
