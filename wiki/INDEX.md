...
**Estado (2026-09-17):** Pre-corrida. Runner real implementado. Pre-registro en borrador
(4 campos pendientes de decisión humana). Sin corridas reales ejecutadas aún.
Suite de tests: 96 passed (verificado 2026-09-17). Requiere `pip install -e .` en el venv
antes de la primera ejecución de tests en entorno limpio.

**Bloqueo persistente (11ª noche):** Las 3 tareas de ejecución (piloto de banda, controles,
